...
class Console(QtWidgets.QWidget):
    ...
    def run(self, app, window):
        ...
        redirect = Redirect(self.errorwrite)
        with redirect_stdout(self), redirect_stderr(redirect):
            window.show()
            sys.exit(app.exec())
