...
from PySide6.QtCore import Qt, QEvent, QObject, QRegularExpression
...
def find_children(parent: Type[QObject], type: Type[QObject], name: Union[str, QRegularExpression] = '',
