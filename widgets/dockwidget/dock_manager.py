...
from PySide6.QtCore import (QByteArray, QSettings, QXmlStreamReader,
                         QXmlStreamWriter, Signal)
from PySide6.QtGui import QIcon, QAction
from PySide6.QtWidgets import QMainWindow, QMenu, QWidget

from widgets.dockwidget.enums import InsertionOrder, DockFlags, DockWidgetArea, OverlayMode

from widgets.dockwidget.dock_container_widget import DockContainerWidget
from widgets.dockwidget.dock_overlay import DockOverlay
from widgets.dockwidget.floating_dock_container import FloatingDockContainer
from widgets.dockwidget.util import LINUX

try:
    from PySide6.QtCore import qCompress, qUncompress
except ImportError:
    qCompress = None
    qUncompress = None
