...
from widgets.dockwidget import DockManager, DockWidgetArea, DockWidget
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        for label_text, area in (
                ('1 Top', DockWidgetArea.top),
                ('2 Bottom', DockWidgetArea.bottom),
                ('3 Left', DockWidgetArea.left),
                ('4 Right', DockWidgetArea.right),
        ):
            ...
            dock_widget = DockWidget(label_text)
