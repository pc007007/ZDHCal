...
from PySide6.QtCore import QRect, QXmlStreamWriter, Signal
from PySide6.QtGui import QAction
from PySide6.QtWidgets import QAbstractButton, QBoxLayout, QFrame

from widgets.dockwidget.util import (find_parent, DEBUG_LEVEL, hide_empty_parent_splitters,
                   emit_top_level_event_for_widget)
from widgets.dockwidget.enums import TitleBarButton, DockWidgetFeature
from widgets.dockwidget.dock_area_layout import DockAreaLayout

if TYPE_CHECKING:
    from widgets.dockwidget import (DockContainerWidget, DockManager, DockWidget, DockWidgetTab,
