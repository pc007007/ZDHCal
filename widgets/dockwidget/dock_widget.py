...
from PySide6.QtCore import QEvent, QSize, QXmlStreamWriter, Qt, Signal
from PySide6.QtGui import QIcon, QAction
from PySide6.QtWidgets import (QBoxLayout, QFrame, QScrollArea,
                            QSplitter, QToolBar, QWidget)

from widgets.dockwidget.enums import (DockWidgetFeature, WidgetState, ToggleViewActionMode,
                    InsertMode)
from widgets.dockwidget.util import find_parent, emit_top_level_event_for_widget

if TYPE_CHECKING:
    from widgets.dockwidget import DockAreaWidget, DockManager, DockWidgetTab
