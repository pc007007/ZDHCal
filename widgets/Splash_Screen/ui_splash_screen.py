...
################################################################################
## Form generated from reading UI file 'splash_screeneihKJJ.ui'
##
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>AFC\u7cfb\u7edf\u8ba1\u7b97\u8f6f\u4ef6</p></body></html>", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>\u81ea\u52a8\u5316\u4fe1\u606f\u8bbe\u8ba1\u6240</p></body></html>", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"\u8f7d\u5165\u4e2d...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>\u7248\u672c\u53f7: 1.1</p></body></html>", None))
    # retranslateUi
