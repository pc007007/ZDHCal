...
from PySide6.QtGui import Qt, QPen, QColor, QPainterPath
from PySide6.QtWidgets import QGraphicsPathItem, QGraphicsItem

from widgets.module.afcx.nodeEditor.node_socket import RIGHT_TOP, RIGHT_BOTTOM, LEFT_BOTTOM, LEFT_TOP
...
class QNEGraphicsEdge(QGraphicsPathItem):
    def __init__(self, edge, parent=None):
        super(QNEGraphicsEdge, self).__init__(parent)
